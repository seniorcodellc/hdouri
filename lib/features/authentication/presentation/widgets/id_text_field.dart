...
class IdTextField extends StatelessWidget {
  const IdTextField({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(AppStrings.idNumber,style: getMediumTextStyle(fontSize: 14.sp,color: AppColors.grayHint),),
        8.vs,
